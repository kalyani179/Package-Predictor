...
public class About extends JPanel{
    public About() {
        ...
        heading.setBounds(0, 20, Constants.width - 100, 50); // Adjust position and size of heading label
        ...
        content.setBounds(50, 110, Constants.width - 100, 500); // Adjust position and size of content label
